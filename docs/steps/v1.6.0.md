...
**Total: 8 cambios organizados por prioridad**
...
- [ ] En mobile, al abrir un accordion los demas se cierran
- [ ] Accordion con item activo puede cerrarse
- [ ] Scroll funciona correctamente

### Fase 2 - Dropdown

- [ ] Dropdown de categoria padre tiene scroll interno
- [ ] Se pueden ver todas las opciones haciendo scroll
- [ ] No hay overflow fuera del viewport

### Fase 3 - Ahorro Tasas

- [ ] Card muestra valor correcto del mes actual
- [ ] Formula calcula ahorro/perdida segun tipo de transaccion
- [ ] Muestra $0 solo si no hay transacciones con tasa custom

### Fase 4 y 5 - Colores y Fondo

- [ ] Colores pasteles aplicados en modo oscuro
- [ ] Fondo gris #2a2a2a en modo oscuro
- [ ] Modo claro sin cambios
- [ ] Graficos usan nuevos colores

### Fase 6 - Comparacion Tasas

- [ ] Lista compacta en lugar de grafica
- [ ] Muestra todos los pares de monedas con sus tasas
- [ ] Fuente de la tasa visible (Binance/Oficial)

### Fase 7 - Balance Cuenta

- [ ] Valores mostrados en USD
- [ ] Tooltip muestra valor original
- [ ] Conversion correcta usando tasa del sistema

### Fase 8 - Sistema Vueltos

- [ ] Toggle activa/desactiva seccion de vueltos
- [ ] Calculo en tiempo real del monto neto
- [ ] Vuelto misma cuenta: ajusta monto automaticamente
- [ ] Vuelto diferente cuenta: crea transferencia
- [ ] Advertencia si vuelto > monto
- [ ] Funciona en gastos e ingresos

---

## Notas Adicionales

- Las fases 4 y 5 (colores) pueden combinarse en una sola PR
- La fase 8 (vueltos) es la mas compleja y puede dividirse en sub-PRs
- Priorizar bugs antes de mejoras visuales
- Mantener retrocompatibilidad con datos existentes

---

_WalletWise v1.6.0 - Polish & Improvements (Planificado)_
